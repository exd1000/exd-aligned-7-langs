...
// ✅ Access
console.log(memoryBank["brunch"]);  // "yum"

// ✨ Add/update
memoryBank["walk"] = "calm";
memoryBank["fight"] = "ugh";
...
sceneSet.add("beach");
sceneSet.add("beach");  // Won’t duplicate
sceneSet.add("brunch");

console.log(sceneSet);  // Set { 'beach', 'brunch' }

// 🔁 Looping over Set
for (let scene of sceneSet) {
